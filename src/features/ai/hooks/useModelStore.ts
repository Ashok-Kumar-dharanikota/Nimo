...
export const AVAILABLE_MODELS: AvailableModel[] = [
  {
    id: 'llama3_2_1b',
    name: 'Nimo',
    characterName: 'Nimo - Your AI Companion',
    description: 'Nimo has seen it all. Like an old soul sitting by a campfire, Nimo offers profound reflections and asks the exact questions you didn\'t know you needed to hear. He\'s here to guide your deepest thoughts.',
